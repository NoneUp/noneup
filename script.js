const grid = document.getElementById("grid");
        ...
        function openModal(modalId) {
            ...
            if (modalOverlay) {
                modalOverlay.classList.add('show'); // Додаємо клас для відображення
                modalOverlay.setAttribute('aria-hidden', 'false');
                modalOverlay.focus(); // Фокус на модальне вікно для доступності
            }
        }
        ...
        function closeModal(modalId) {
            const modalOverlay = document.getElementById(modalId);
            if (modalOverlay) {
                modalOverlay.classList.remove('show'); // Видаляємо клас для приховування
        ...
        // Обробники подій для кнопок закриття модальних вікон
        ...
        // Закриття модалок по кліку поза їх вмістом
        ...
        // Обробка PWA модального вікна
        installButton.addEventListener('click', () => {
            openModal('installModalOverlay');
            if (gameStarted && !paused) {
                togglePause();
            }
        });
        ...
        closeInstallModalBtn.addEventListener('click', () => {
            closeModal('installModalOverlay');
            if (gameStarted && paused) {
                togglePause();
            }
        });

        // --- Кінець виправлень для модальних вікон ---
